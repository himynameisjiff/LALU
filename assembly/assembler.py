import sys
# All credit to Mr. Mueller. None of this code was written by me, except a minor alteration at the end.
...
if not error:
   ...
   print('\n'.join(program.split()))
   #altered into a list for better readability
